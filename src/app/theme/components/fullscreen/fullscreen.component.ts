...
export class FullScreenComponent {
    ...
    @ViewChild('expand', null) private expand:ElementRef;
    @ViewChild('compress', null) private compress:ElementRef;
    ...
    @HostListener('window:resize') onFullScreenChange(){
        let fullscreenElement = document.msFullscreenElement || document.mozFullScreenElement ||
